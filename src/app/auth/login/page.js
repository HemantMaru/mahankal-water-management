...
export default function LoginPage() {
  ...
  return (
    // Same wrapper logic: natural scroll on mobile, locked on desktop
    <div className="flex flex-col lg:flex-row min-h-screen lg:h-screen w-full bg-white lg:overflow-hidden font-sans selection:bg-blue-600 selection:text-white">
      ...
      <div className="relative w-full min-h-[320px] sm:min-h-[400px] lg:h-full lg:w-[55%] shrink-0 overflow-hidden bg-slate-900 flex flex-col justify-end p-5 lg:p-10 lg:pb-6 z-10">
        ...
        <div className="relative z-20 max-w-xl space-y-3 lg:space-y-4 animate-in fade-in slide-in-from-left-8 duration-1000 mt-12">
          ...
          <p className="text-xs lg:text-sm text-slate-200 leading-relaxed max-w-md font-medium hidden sm:block">
            Access your dashboard to track deliveries, manage your subscription,
            and enjoy uninterrupted purity at your doorstep.
          </p>
      ...
      <div className="w-full lg:w-[45%] flex-1 lg:h-full lg:overflow-y-auto flex items-center justify-center p-5 sm:p-8 bg-white z-20">
        <div className="w-full max-w-[420px] flex flex-col space-y-6 py-4 lg:py-0">
          {/* Header */}
          <div>
          ...
          >
            ...
            <div className="flex flex-col gap-4 lg:gap-3">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  {...form.register("emailOrMobile")}
                  className="pl-10 h-12 lg:h-11 bg-slate-50 border-slate-200 focus:bg-white focus:border-blue-500 rounded-xl font-medium text-sm transition-all"
                />

                {form.formState.errors.emailOrMobile && (
                  <p className="text-red-500 text-xs">
                    {form.formState.errors.emailOrMobile.message}
                  </p>
                )}
              </div>
            ...
            <Button
              ...
              className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-bold shadow-md shadow-blue-600/20 group transition-all duration-300 mt-2"
            >
            ...
            <Button
              ...
              variant="outline"
              className="w-full h-12 border-slate-200 hover:bg-slate-50 hover:border-slate-300 rounded-xl text-slate-700 font-bold flex items-center justify-center gap-2 transition-all duration-300"
            >
              <svg
                viewBox="0 0 24 24"
                width="18"
          ...
          {/* Footer Link */}
          <p className="text-center text-xs font-medium text-slate-500 pt-2 lg:pt-0">
