...
import { ShoppingCart, MapPin, CalendarClock, ArrowRight } from "lucide-react";

export default function CustomerHero() {
  return (
    <div className="relative h-72 rounded-[32px] overflow-hidden mb-8 group shadow-2xl shadow-primary/10 bg-slate-900">
      <img
        src="{{DATA:IMAGE:IMAGE_74}}"
        ...
        <div className="max-w-xl space-y-6 animate-in fade-in slide-in-from-left-8 duration-700">
          ...
          <div>
            <h1 className="text-4xl font-black text-white leading-tight tracking-tight">
              Welcome Back,{" "}
              <span className="text-cyan-400 italic">Hemant 👋</span>
            </h1>
            <p className="text-slate-200 font-medium text-lg mt-2 leading-relaxed opacity-90 max-w-md">
              Manage your water deliveries, subscriptions and payments from one
              unified dashboard.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button
              size="lg"
              variant="ghost"
              className="text-white hover:bg-white/10 rounded-2xl px-6 h-12 font-black transition-all"
            >
      ...
      <div className="absolute bottom-6 right-12 hidden xl:flex gap-4">
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/10 px-6 py-4 rounded-[24px]">
          ...
          <div className="text-xl font-black text-white mt-1">₹840.00</div>
        </div>
      </div>
    </div>
  );
